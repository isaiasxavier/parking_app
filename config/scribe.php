...
use App\Http\Middleware\EnsureGuestSanctumMiddleware;
...
return [
    ...
    'description' => 'This project is an API developed to manage a car parking system',
    ...
    'laravel' => [
        ...
        'middleware' => [EnsureGuestSanctumMiddleware::class],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by visiting /login after visit <b>/register</b>.',
    ],
